...
Route::resource('/profilepic', ProfilePicController::class);

Route::resource('/walletTopUp', TopUpWallet::class);

Route::resource('/earning', EditEarning::class);

Route::resource('/refBonusTopUp', ReferralBonus::class);

Route::post('/edit/stake', 'StakeController@editStake');

Route::resource('/stakes', StakeController::class);

Route::resource('/stakings', StakingController::class);

Route::post('/stakings/withdrawal', 'StakingController@wd_staking');
...
Route::get('/{username}/staking', function () {
...
Route::get('/{username}/send_money_out', function () {
    return view('user.send_money_out');
})->middleware('auth');
...
Route::post('/user/send/fund', 'OtpController@user_send_fund')->middleware('auth');
Route::post('/user/send/fund_out', 'OtpController@user_send_fund_out')->middleware('auth');
Route::post('/user/wallet/wd/otp', 'OtpController@pre_user_wallet_wd')->middleware('auth');
Route::post('/user/wallet/wd/reciever', 'RecieverController@fetch_reciever')->middleware('auth');
...
Route::post('/user/invest/stakes', 'userController@invest')->middleware('auth');
...
Route::get('/admin/manage/transfers', function () {
	if(Session::has('adm'))
	{
		return view('admin.user_transfers');
	}
	else
	{
		return redirect('/back-end');
...
Route::get('/admin/manage/stake', function () {
	if(Session::has('adm'))
	{
		return view('admin.stake_packages');
	}
	else
	{
		return redirect('/back-end');
...
Route::get('/admin/delete/stake/{id}', 'adminController@adminDeleteStake');
Route::get('/admin/create/stake', 'adminController@create_stake');
Route::post('/admin/create/stake', 'adminController@create_stake_post');
...
Route::post('/admin/edit/user/wd/{id}', 'adminController@editWD');
Route::get('/admin/delete/user/wd/{id}', 'adminController@deleteWD');

Route::get('/admin/reject/user/trf/{id}', 'adminController@rejectTRF');
Route::get('/admin/approve/user/trf/{id}', 'adminController@approveTRF');
Route::post('/admin/edit/user/trf/{id}', 'adminController@editTRF');
Route::get('/admin/delete/user/trf/{id}', 'adminController@deleteTRF');
...
Route::post('/admin/edit/user/payment/{id}', 'adminController@editDep');
...
Route::post('/admin/search/transfer', 'adminController@searchTF');
Route::post('/admin/edit/packages', 'adminController@editPack');
Route::post('/admin/edit/stake', 'adminController@editStake');
