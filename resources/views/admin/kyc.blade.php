                                            ...
                                            @if(count($kyc) > 0 )
                                                @foreach($kyc as $user)
                                                    <tr>
                                                        <td>{{$user->username}}</td>                                                        
                                                        <td>
                                                            <a target="_blank" href="{{ env('APP_URL').'/img/kyc/'.$user->selfie }}" class=" text-info">
                                                                <i class="fa fa-eye"></i>View
                                                            </a>
                                                        </td> 
                                                        <td>{{$user->card_type}}</td>
                                                        <td>
                                                            <a target="_blank" href="{{ env('APP_URL').'/img/kyc/'.$user->front_card }}" class=" text-info">
                                                                <i class="fa fa-eye"></i>View
                                                            </a>
                                                        </td>  
                                                        <td>
                                                            @if(!empty($user->back_card))
                                                            <a target="_blank" href="{{ env('APP_URL').'/img/kyc/'.$user->back_card }}" class=" text-info">
                                                                <i class="fa fa-eye"></i>View
                                                            </a>
                                                            @endif
                                                        <td>
                                                            <a target="_blank" href="{{ env('APP_URL').'/img/kyc/'.$user->address_proof }}" class=" text-info">
                                                                <i class="fa fa-eye"></i>View
                                                            </a>                                                            
                                                        </td>
                                                        <td>
