                                                        ...
                                                        <div class="col-md-6 d-flex flex-column justify-content-around">
                                                            ...
                                                            <a id="wd_bal" title="Click to Edit" href="javascript:void(0)" >
                                                                <div class="border_btm">							
                                                                    ...
                                                                    <div class="colhd margin_n10">{{ __('Click to Edit Fund') }}</div>
                                                                </div>
                                                            </a>
                                        ...
                                        <div id="wallet_wd" class="container popmsgContainer" >
                                            <div class="row padding_per_2_2">
                                              ...
                                              <div class="col-md-4 popmsg-mobile card" align="Center">        
                                                <div class="card-title">
                                                  <br>
                                                  <h3><b>{{ __('Edit Wallet Balance') }}</b></h3>
                                                  <h5 class="text-danger"><b>{{ __('Wallet Balance:') }}</b></h5> 
                                                              <h3 class="fw-bold">$ {{ number_format($user->wallet, 2) }}</h3>
                                                ...
                                                <div class="card-body">
                                                    <form id="wd_formssss" action="/walletTopUp" method="post">
                                                        ...
                                                        <input id="" type="hidden" class="form-control" name="bank" value="{{ $user->id }}"  required placeholder="Enter Amount to update" >
                                                        <div class="form-group">
                                                          <br><br>
                                            ...
                                            <div class="row padding_per_2_2">
                                              ...
                                              <div class="col-md-4 popmsg-mobile card" align="Center">        
                                                <div class="panel-heading" style="">
                                                  <br>
                                                  <h3><b>{{ __('Edit Referral Bonus') }}</b></h3>
                                                  <h5 class="text-danger"><b>{{ __('Referral Bonus:') }}</b>${{$user->ref_bal}}</h5>         
                                                  <hr>
                                                </div>
                                                <div id="" >
                                                      {{ __('Enter Referral Bonus') }}
                                                     <form id="wd_formssss" action="/refBonusTopUp" method="post">
                                                        ...
                                                        <input id="" type="hidden" class="form-control" name="bank" value="{{ $user->id }}"  required placeholder="Enter Bonus Amount to update" >
                                                        <div class="form-group">
                                                          <br><br>
                                                            <button class="collb btn btn-info">{{ __('Update') }}</button>
                                                            <span style="">            
