                            ...
                            <div class="row "> 
                              ...
                              <div class="col-md-6">
                                <div class="card pad_20" >
                                    ...
                                    <div class="form-group">
                                        <h5> {{ __('Bank Name') }} </h5>
                                        <input type="text" name="bank_name1" value="{{env('BANK_NAME1')}}" class="form-control"  >
                                    </div>
                                    <div class="form-group">
                                        <h5> {{ __('Account Name') }} </h5>
                                        <input type="text" name="act_name1" value="{{env('ACCOUNT_NAME1')}}" class="form-control" placeholder="" >
                                    </div> 

                                    <div class="form-group">
                                        <h5> {{ __('Account Number') }} </h5>
                                        <input type="text" name="act_no1" value="{{env('ACCOUNT_NUMBER1')}}" class="form-control" placeholder="" >
                                    </div> 
                                    <div class="form-group">
                                        <h5> {{ __('Response Email') }} </h5>
                                        <input type="email" name="dep_email1" value="{{env('BANK_DEPOSIT_EMAIL1')}}" class="form-control" placeholder="" >
                                    </div>  
                                    <div class="" align="right"> 
                                        <b>On/Off</b><br>             
                                        <label class="switch">
                                          <input id="switch_bank_deposit1" type="checkbox" name="switch_bank_deposit1"  value="{{env('BANK_DEPOSIT_SWITCH1')}}" @if(env('BANK_DEPOSIT_SWITCH1') == 1){{'checked'}}@endif>
                              ...
                              <div class="col-md-6">
                                  <div class="card pad_20" >
                                      ...
                                      <div class="form-group">
                                          <h5> {{ __('Wallet Address Host 1/Address Type 1') }} </h5>
                                          <input type="text" name="bank_name" value="{{env('BANK_NAME')}}" class="form-control" placeholder="Eg : Coinbase, Binance, Metamask etc"  >
                                      </div>
                                      <div class="form-group">
                                          <h5> {{ __('Wallet Address 1') }} </h5>
                                      ...
                                      <div class="form-group">
                                          <h5> {{ __('Wallet Address Host 2/Address Type 2') }} </h5>
                                          <input type="text" name="bank_name2" value="{{env('BANK_NAME2')}}" class="form-control" placeholder="Eg : Coinbase, Binance, Metamask etc"  >
                                      </div>
                                      <div class="form-group">
                                          <h5> {{ __('Wallet Address 2') }} </h5>
                                          <input type="text" name="act_name2" value="{{env('ACCOUNT_NAME2')}}" class="form-control" placeholder="" >
                                      </div> 



                                      <div class="form-group">
                                          <h5> {{ __('Wallet Address Host 3/Address Type 3') }} </h5>
                                          <input type="text" name="bank_name3" value="{{env('BANK_NAME3')}}" class="form-control" placeholder="Eg : Coinbase, Binance, Metamask etc"  >
                                      </div>
                                      <div class="form-group">
                                          <h5> {{ __('Wallet Address 3') }} </h5>
                                          <input type="text" name="act_name3" value="{{env('ACCOUNT_NAME3')}}" class="form-control" placeholder="" >
                                      </div>  


                                      <div class="form-group">
                                        <h5> {{ __('Wallet Address Host 4/Address Type 4') }} </h5>
                                        <input type="text" name="bank_name3" value="{{env('BANK_NAME3')}}" class="form-control" placeholder="Eg : Coinbase, Binance, Metamask etc"  >
                                      </div>
                                      <div class="form-group">
                                          <h5> {{ __('Wallet Address 4') }} </h5>
                                          <input type="text" name="act_name4" value="{{env('ACCOUNT_NAME4')}}" class="form-control" placeholder="" >
                                      </div> 


                                      {{-- <div class="form-group"> --}}
                                          {{-- <h5> {{ __('Account Number') }} </h5> --}}
                                          <input type="hidden" value="NIL" name="act_no" value="{{env('ACCOUNT_NUMBER')}}" class="form-control" placeholder="" >
                                      {{-- </div>  --}}
                                      <div class="form-group">
                                          <h5> {{ __('Response Email') }} </h5>
