    ...
    <div class="col-md-4" align="Center">
      <div class="card mt50">      
        ...
        <div id="" class="edit_pack_pad_n30_5 card-body">
          <form action="/edit/stake" method="post">
                ...
                <!-- <div class="input-group">
                    <div class="input-group-prepend " >
                        <span class="input-group-text " ><i class=""></i>Pool Name</span>
                    </div>                      
                    <input id="package_name" type="text" class="form-control" name="package_name" placeholder="Enter Pool name" required>
                ...
                <div class="input-group">
                    <div class="input-group-prepend " >
                        <span class="input-group-text "><i class=""></i>Coin Out</span>
                    </div>
                    <input id="coin_out" type="text" class="form-control" name="coin_out" placeholder="Enter Staking coin output" required>
                    <div class="input-group-append " >
                        <span class="input-group-text pack_edit_cur" ><i class=""></i></span>
                    </div> 
                </div>
