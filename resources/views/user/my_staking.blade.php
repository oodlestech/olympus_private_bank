...
@Section('content')
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-head-row">
                                        <div class="card-title">{{ __('My Stakes') }}</div>                                       
                                    </div>
                                </div>
                                <div class="card-body ">  
                                    <div class="table-responsive web-table">
                                        ...
                                        <div class="text-right col-md-12">{{ $stakings->links() }}</div>
                                    </div>
    ...
    @include('user.inc.confirm_stake')
    @include('user.inc.unstaking')
