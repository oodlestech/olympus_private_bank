                                                ...
                                                <div id="pay_cont" class="row">
                                                    ...
                                                    <div class="col-lg-6 mt-5">                                                                    
                                                        <div class="payment_method" align="center">
                                                            ...
                                                            <p>
                                                                {{ __('Pay using cryptocurrency system') }}
                                                            </p> 
                                                    ...
                                                    <div class="col-lg-6 mt-5">                                                                    
                                                        <div class="payment_method" align="center">
                                                            ...
                                                            <p>
                                                                {{ __('Pay Using Bank Transfer') }}
                                                            </p> 
                                                           
                                                            <div align="">
                                                                <a id="pay_with_bank_dep1" href="javascript:void(0)" class="btn btn_blue" >
                                                                    {{ __('Bank Transfer') }}
                                                                </a>
                                                            </div> 
                                                            <div id="bank_dets1" align="" class="cont_display_none">
                                                                <div class="row mt-5 border border-primary rounded">              
                                                                    <div class="col-sm-12 mb-5">
                                                                        
                                                                        <h4 class="text-info">Account Number: {{env('ACCOUNT_NUMBER1')}}</h4>
                                                                        {{-- <h5 class="">Account Number: {{env('ACCOUNT_NUMBER1')}}</h5> --}}
                                                                    </div>

                                                                    <div class="col-sm-12 mb-5">
                                                                        
                                                                        <h4 class="text-info">Account Name: {{env('ACCOUNT_NAME1')}}</h4>
                                                                        {{-- <h5 class="">Account Name: {{env('ACCOUNT_NAME1')}}</h5> --}}
                                                                    </div>

                                                                    <div class="col-sm-12 mb-5">
                                                                        
                                                                        <h4 class="text-info">Bank Name: {{env('BANK_NAME1')}}</h4>
                                                                        {{-- <h5 class="">Bank Name: {{env('BANK_NAME1')}}</h5> --}}
                                                                    </div>

                                                                    <div class="col-sm-12 mb-5">
                                                                       
                                                                        <h4 class="text-info">Deposit Email: {{env('BANK_DEPOSIT_EMAIL1')}}</h4>
                                                                        {{-- <h5 class="">Deposit Email: {{env('BANK_DEPOSIT_EMAIL1')}}</h5> --}}
                                                                    </div>
                                                                </div>
                                                                <div class="row">              
                                                                    <div class="col-sm-12">
                                                                        <p class="text-danger">
                                                                           {{ __('Make payment to any of the above wallet address and click continue below.') }} 
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                <div class="row">              
                                                    ...
                                                    <div class="col-lg-6 mt-5">                                                                    
                                                        <div class="payment_method" align="center">
                                                            ...
                                                            <div id="bank_dets" align="" class="cont_display_none">
                                                                <div class="row mt-5 border border-primary rounded">              
                                                                    <div class="col-sm-12 mb-5">
                                                                        <h3 class="color_blue_b">
                                                                            <i class="fas fa-money-check-alt color_blue_9"></i> Wallet Host / Address Type: {{env('BANK_NAME')}}
                                                                        </h3>
                                                                        {{-- <h4 class="text-danger">Account Number: {{env('ACCOUNT_NUMBER')}}</h4> --}}
                                                                        <h5 class="">Address: {{env('ACCOUNT_NAME')}}</h5>
                                                                    </div>

                                                                    <div class="col-sm-12 mb-5">
                                                                        <h3 class="color_blue_b">
                                                                            <i class="fas fa-money-check-alt color_blue_9"></i> Wallet Host / Address Type: {{env('BANK_NAME2')}}
                                                                        </h3>
                                                                        {{-- <h4 class="text-danger">Account Number: {{env('ACCOUNT_NUMBER')}}</h4> --}}
                                                                        <h5 class="">Address: {{env('ACCOUNT_NAME2')}}</h5>
                                                                    </div>

                                                                    <div class="col-sm-12 mb-5">
                                                                        <h3 class="color_blue_b">
                                                                            <i class="fas fa-money-check-alt color_blue_9"></i> Wallet Host / Address Type: {{env('BANK_NAME3')}}
                                                                        </h3>
                                                                        {{-- <h4 class="text-danger">Account Number: {{env('ACCOUNT_NUMBER')}}</h4> --}}
                                                                        <h5 class="">Address: {{env('ACCOUNT_NAME3')}}</h5>
                                                                    </div>

                                                                    <div class="col-sm-12 mb-5">
                                                                        <h3 class="color_blue_b">
                                                                            <i class="fas fa-money-check-alt color_blue_9"></i> Wallet Host / Address Type: {{env('BANK_NAME4')}}
                                                                        </h3>
                                                                        {{-- <h4 class="text-danger">Account Number: {{env('ACCOUNT_NUMBER')}}</h4> --}}
                                                                        <h5 class="">Address: {{env('ACCOUNT_NAME4')}}</h5>
                                                                    </div>
                                                                </div>
                                                                <div class="row">              
                                                                    <div class="col-sm-12">
                                                                ...
                                                                <div class="row">              
                                                                    <div class="col-sm-12">
                                                                        <a id="bank_deposit_cont2" href="javascript:void(0)" class="btn btn_blue" >
                                                                            {{ __('Continue') }}
                                                                        </a>
                                                                    </div>
                                                                </div>
                                            ...
                                            @else
                                                <div class="col-lg-6 mt-5">                                                                    
                                                    <div class="payment_method" align="center">
                                                        ...
                                                        <div align="">
                                                            <a id="pay_with_bank_dep2" href="javascript:void(0)" class="btn btn_blue" >
                                                                {{ __('Direct Crypto Transfer') }}
                                                            </a>
                                                        </div> 
                                                        <div id="bank_dets2" align="" class="cont_display_none">
                                                            <div class="row mt-5 border border-primary rounded">              
                                                                <div class="col-sm-12">
                                                                    <h3 class="color_blue_b">
                                                                        <i class="fas fa-money-check-alt color_blue_9"></i> Wallet Host: {{env('BANK_NAME')}}
                                                                    </h3>
                                                                    {{-- <h4 class="text-danger">Account Number: {{env('ACCOUNT_NUMBER')}}</h4> --}}
                                                                    <h5 class="">Address: {{env('ACCOUNT_NAME')}}</h5>
                                                                </div>
                                                            ...
                                                            <div class="row">              
                                                                <div class="col-sm-12">
                                                                    <p class="text-danger">
                                                                    {{ __('Make payment to the above wallet address and click continue below.') }} 
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            <div class="row">              
                                                                <div class="col-sm-12">
                                                                    <a id="bank_deposit_cont3" href="javascript:void(0)" class="btn btn_blue" >
                                                                        {{ __('Continue') }}
                                                                    </a>
                                                                </div>
                                                            </div>
            ...
            <div id="bank_deposit_cont_dets" class="container popmsgContainer" >
                <div class="row">
                  ...
                  <div class="col-md-4 popmsg-mobile card" align="Center">        
                    <div class="mt-2">
                      <h3><b>{{ __('Wallet Deposit Details') }}</b></h3>                              
                      <hr>
                    </div>
                    <div class="">                        
                        <form action="/user/wallet/bank_deposit" method="post">
                            ...
                            <div class="form-group">
                              <div class="input-group" >                   
                                ...
                                <input type="text" class="form-control" name="account_name"  required placeholder="Account name / address sent from" >
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="input-group" >                   
                                ...
                                <input type="text" class="form-control" name="account_no"  required placeholder="Account number / coin name sent" >
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="input-group" >                   
                                ...
                                <input type="text" class="form-control" name="bank_name"  required placeholder="Bank Name / Wallet Host" >
                              </div>
                            </div>
                            <div class="form-group">
                              <br>
