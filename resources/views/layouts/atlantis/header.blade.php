							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									...
									<li>
										...
										<a class="dropdown-item" href="/{{$user->username}}/send_money"><span class="fa fa-paper-plane"></span>&nbsp; Transfer within OlympusPB</a>
										<a class="dropdown-item" href="/{{$user->username}}/send_money_out"><span class="fa fa-paper-plane"></span>&nbsp; Transfer to other Banks</a>
										<a class="dropdown-item" href="/{{$user->username}}/investments"><span class="fa fa-wallet"></span>&nbsp; My Investments</a>
										{{-- <a class="dropdown-item" href="/{{$user->username}}/staking"><span class="fa fa-wallet"></span>&nbsp; Staking</a> --}}
										<a class="dropdown-item" href="/{{$user->username}}/withdrawal"><span class="fa fa-download"></span>&nbsp; Withdrawal</a>
										<a class="dropdown-item" href="/{{$user->username}}/downlines"><span class="fa fa-users"></span>&nbsp; Affiliates</a>
						...
						<li class="nav-item">
							...
							<div class="collapse" id="base">
								<ul class="nav nav-collapse">
									...
									<li class="">
										<a href="/{{$user->username}}/send_money_out">
