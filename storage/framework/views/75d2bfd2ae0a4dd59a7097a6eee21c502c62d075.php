...
<body>
    <div class="row">
        ...
        <div class="col-sm-4" style="border:1px solid #CCC; padding:5%; ">
            <div align="">
        		<img src="<?php echo e(env('APP_URL')); ?>/img/<?php echo e($st->site_logo); ?>" style="height:50px; width:150px;" align="center">
        	</div>
...
</html><?php /**PATH /home/amarachi/Documents/laravel/decadetrades/resources/views/mail/regconfirm.blade.php ENDPATH**/ ?>