            ...
            <div class="content">
                ...
                <div class="page-inner mt--5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="card card-primary <?php if($adm->role < 2): ?> <?php echo e('blur_cnt'); ?><?php endif; ?>" style="background: #598FFA !important;">
                                <div class="card-header">
...
<?php echo $__env->make('admin.atlantis.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/amarachi/Documents/laravel/triveinvestments/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>