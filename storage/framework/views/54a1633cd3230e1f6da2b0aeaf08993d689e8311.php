                                        ...
                                        <?php else: ?>
                                            <?php if($settings->deposit == 1): ?>      
                                                <div id="pay_cont" class="row">
                                                    ...
                                                    <?php if(env('BANK_DEPOSIT_SWITCH1') == 1): ?>
                                                    <div class="col-lg-6 mt-5">                                                                    
                                                        <div class="payment_method" align="center">
                                                            <p>
                                                            ...
                                                            <p>
                                                                <?php echo e(__('Pay Using Bank Transfer')); ?>
                                                            ...
                                                            <div id="bank_dets1" align="" class="cont_display_none">
                                                                <div class="row mt-5 border border-primary rounded">              
                                                                    <div class="col-sm-12 mb-5">
                                                                        ...
                                                                        <h4 class="text-info">Account Number: <?php echo e(env('ACCOUNT_NUMBER1')); ?></h4>
                                                                        
                                                                    </div>

                                                                    <div class="col-sm-12 mb-5">
                                                                        
                                                                        <h4 class="text-info">Account Name: <?php echo e(env('ACCOUNT_NAME1')); ?></h4>
                                                                        
                                                                    </div>

                                                                    <div class="col-sm-12 mb-5">
                                                                        
                                                                        <h4 class="text-info">Bank Name: <?php echo e(env('BANK_NAME1')); ?></h4>
                                                                        
                                                                    </div>

                                                                    <div class="col-sm-12 mb-5">
                                                                       
                                                                        <h4 class="text-info">Deposit Email: <?php echo e(env('BANK_DEPOSIT_EMAIL1')); ?></h4>
...
<?php echo $__env->make('layouts.atlantis.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/amarachiugwu/Work/laravel/olympuspb-back/resources/views/user/load_wallet.blade.php ENDPATH**/ ?>