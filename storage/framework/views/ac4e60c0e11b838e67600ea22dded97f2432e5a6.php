...
<body>
	<div class="wrapper">
							...
							<ul class="dropdown-menu dropdown-adm animated fadeIn">
								<div class="dropdown-adm-scroll scrollbar-outer">
									...
									<li>																			
										...
										<a class="dropdown-item" href="/admin/manage/stake">
											<span class="fa fa-briefcase"></span>&nbsp; Stakes
										</a>
		...
		<!-- End Sidebar --><?php /**PATH /home/amarachi/Documents/laravel/triveinvestments/resources/views/admin/atlantis/header.blade.php ENDPATH**/ ?>