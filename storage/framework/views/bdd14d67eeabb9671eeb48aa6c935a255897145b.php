...
<?php $__env->startSection('content'); ?>
    ...
    <section class="banner-section" id="home">
            <div class="banner-bg d-lg-none">
                <img src="/assets2/images/banner/banner-bg2.jpg" alt="banner">
            </div>
            <div class="banner-bg d-none d-lg-block bg_img" data-background="/assets2/images/banner/banner.jpg">
                <div class="chart-1 wow fadeInLeft" data-wow-delay=".5s" data-wow-duration=".7s">
                    <img src="/assets2/images/banner/chart1.png" alt="banner">
                </div>
                <div class="chart-2 wow fadeInDown" data-wow-delay="1s" data-wow-duration=".7s">
                    <img src="/assets2/images/banner/chart2.png" alt="banner">
                </div>
                <div class="chart-3 wow fadeInRight" data-wow-delay="1.5s" data-wow-duration=".7s">
                    <img src="/assets2/images/banner/chart3.png" alt="banner">
                </div>
                <div class="chart-4 wow fadeInUp" data-wow-delay="2s" data-wow-duration=".7s">
                    <img src="/assets2/images/banner/clock.png" alt="banner">
                </div>
            </div>
            <div class="animation-area d-none d-lg-block">
                <div class="plot">
                    <img src="/assets2/images/banner/plot.png" alt="banner">
                </div>
                <div class="element-1 wow fadeIn" data-wow-delay="1s">
                    <img src="/assets2/images/banner/light.png" alt="banner">
                </div>
                <div class="element-2 wow fadeIn" data-wow-delay="1s">
                    <img src="/assets2/images/banner/coin1.png" alt="banner">
                </div>
                <div class="element-3 wow fadeIn" data-wow-delay="1s">
                    <img src="/assets2/images/banner/coin2.png" alt="banner">
                </div>
                <div class="element-4 wow fadeIn" data-wow-delay="1s">
                    <img src="/assets2/images/banner/coin3.png" alt="banner">
                </div>
                <div class="element-5 wow fadeIn" data-wow-delay="1s">
                    <img src="/assets2/images/banner/coin4.png" alt="banner">
                </div>
                <div class="element-6 wow fadeIn" data-wow-delay="1s">
                    <img src="/assets2/images/banner/coin5.png" alt="banner">
                </div>
                <div class="element-7 wow fadeIn" data-wow-delay="1s">
                    <img src="/assets2/images/banner/coin6.png" alt="banner">
                </div>
                <div class="element-8 wow fadeIn" data-wow-delay="1s">
                    <img src="/assets2/images/banner/sheild.png" alt="banner">
                </div>
                <div class="element-9 wow fadeIn" data-wow-delay="1s">
                    <img src="/assets2/images/banner/coin7.png" alt="banner">
                </div>
            </div>
            <div class="container">
                <div class="row">
            ...
            <div class="container">
                <div class="row align-items-center mb-30-none justify-content-center">
                    <div class="col-sm-6 col-md-4">
                        <div class="counter-item">
                            <div class="counter-thumb">
                                <img src="/assets2/images/counter/counter01.png" alt="counter">
                            </div>
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="counter-item">
                            <div class="counter-thumb">
                                <img src="/assets2/images/counter/counter02.png" alt="counter">
                            </div>
                            <div class="counter-content">
                                <div class="counter-header">
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="counter-item">
                            <div class="counter-thumb">
                                <img src="/assets2/images/counter/counter03.png" alt="counter">
                            </div>
                            <div class="counter-content">
                                <div class="counter-header">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 d-none d-lg-block rtl">
                        <img src="/assets2/images/about/about.png" alt="about">
                    </div>
                    <div class="col-lg-6">
                        <div class="section-header left-style">
                            <span class="cate">WELCOME TO DECADETRADES</span>
                            <h2 class="title">about Decadetrades</h2>
                            <p>
                                Decadetrades is an investment company, whose team is working on making money from the volatility of cryptocurrencies and offer great returns to our clients.
                            </p>
                        </div>
                        <div class="about--content">
                            <div class="about-item">
                                <div class="about-thumb">
                                    <img src="/assets2/images/about/about01.png" alt="about">
                                </div>
                                <div class="about-content">
                            ...
                            <div class="about-item">
                                <div class="about-thumb">
                                    <img src="/assets2/images/about/about02.png" alt="about">
                                </div>
                                <div class="about-content">
                            ...
                            <div class="about-item">
                                <div class="about-thumb">
                                    <img src="/assets2/images/about/about03.png" alt="about">
                                </div>
                                <div class="about-content">
        ...
        <section class="feature-section padding-top padding-bottom bg_img" data-background=".//assets2/images/feature/feature-bg.png" id="feature">
            <div class="ball-1" data-paroller-factor="-0.30" data-paroller-factor-lg="0.60"
            data-paroller-type="foreground" data-paroller-direction="horizontal">
                <img src="/assets2/images/balls/ball1.png" alt="balls">
            </div>
            <div class="ball-2" data-paroller-factor="-0.30" data-paroller-factor-lg="0.60"
            data-paroller-type="foreground" data-paroller-direction="horizontal">
                <img src="/assets2/images/balls/ball2.png" alt="balls">
            </div>
            <div class="ball-3" data-paroller-factor="0.30" data-paroller-factor-lg="-0.30"
            data-paroller-type="foreground" data-paroller-direction="horizontal">
                <img src="/assets2/images/balls/ball3.png" alt="balls">
            </div>
            <div class="container">
                    ...
                    <div class="col-md-6 col-sm-10 col-lg-4">
                        <div class="feature-item">
                            <div class="feature-thumb">
                                <img src="/assets2/images/feature/feature01.png" alt="feature">
                            </div>
                            <div class="feature-content">
                                <h5 class="title">Profitable Investment</h5>
                                <p>Our investment are guaranteed for high yield </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-10 col-lg-4">
                        <div class="feature-item">
                            <div class="feature-thumb">
                                <img src="/assets2/images/feature/feature02.png" alt="feature">
                            </div>
                            <div class="feature-content">
                                <h5 class="title">DDS Protection</h5>
                                <p>Our platform is fully secured from attacks</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-10 col-lg-4">
                        <div class="feature-item">
                            <div class="feature-thumb">
                                <img src="/assets2/images/feature/feature03.png" alt="feature">
                            </div>
                            <div class="feature-content">
                                <h5 class="title">24/7 Support Center</h5>
                                <p>Our support is open any time, we operate round the clock</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="hover-tab-area">
                                <div class="tab-area">
                                    <div class="tab-item active first">
                                        <img src="/assets2/images/how/how01.png" alt="how">
                                    </div>
                                    <div class="tab-item second">
                                        <img src="/assets2/images/how/how02.png" alt="how">
                                    </div>
                                    <div class="tab-item third">
                                        <img src="/assets2/images/how/how03.png" alt="how">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <ul class="tab-menu">
                                    ...
                                    <li>
                                        ...
                                        <div class="menu-content">
                                            ...
                                            <p>
                                                You will get your profit on your profile, as soon as your investment elapses, request withdrawal and you will get Instant Payment.
                                            </p>
                                        </div>
                                    </li>
                                </ul>
        ...
        <section class="call-section call-overlay bg_img" data-background="/assets2/images/call/call-bg.jpg">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-7">
                        <div class="call--item">
                    ...
                    <div class="col-lg-5">
                        <div class="call-button">
                            <a href="Tel:0939303" class="call">
                                <img src="/assets2/images/call/icon02.png" alt="call">
                            </a>
                            <a href="mailto:support@decadetrades.com" class="custom-button"> Contact Support</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- <section class="latest-transaction padding-top padding-bottom" id="transaction">
            <div class="transaction-bg bg_img" data-background="/assets2/images/transaction/transaction-bg.png">
                            ...
                            <div class="row justify-content-center mb-30-none">
                                <div class="col-lg-4 col-xl-3 col-sm-6">
                                    <div class="transaction-item">
                                        ...
                                        <div class="transaction-thumb">
                                            <img src="/assets2/images/transaction/transaction01.png" alt="transaction">
                                        </div>
                                ...
                                <div class="col-lg-4 col-xl-3 col-sm-6">
                                    <div class="transaction-item">
                                        ...
                                        <div class="transaction-thumb">
                                            <img src="/assets2/images/transaction/transaction02.png" alt="transaction">
                                        </div>
                                        <div class="transaction-footer">
                                            <span class="amount">Amount</span>
                                ...
                                <div class="col-lg-4 col-xl-3 col-sm-6">
                                    <div class="transaction-item">
                                        ...
                                        <div class="transaction-thumb">
                                            <img src="/assets2/images/transaction/transaction03.png" alt="transaction">
                                        </div>
                                        <div class="transaction-footer">
                                            <span class="amount">Amount</span>
                                ...
                                <div class="col-lg-4 col-xl-3 col-sm-6">
                                    <div class="transaction-item">
                                        ...
                                        <div class="transaction-thumb">
                                            <img src="/assets2/images/transaction/transaction04.png" alt="transaction">
                                        </div>
                                        <div class="transaction-footer">
                                            <span class="amount">Amount</span>
                                ...
                                <div class="col-lg-4 col-xl-3 col-sm-6">
                                    <div class="transaction-item">
                                        ...
                                        <div class="transaction-thumb">
                                            <img src="/assets2/images/transaction/transaction05.png" alt="transaction">
                                        </div>
                                        <div class="transaction-footer">
                                            <span class="amount">Amount</span>
                                ...
                                <div class="col-lg-4 col-xl-3 col-sm-6">
                                    <div class="transaction-item">
                                        ...
                                        <div class="transaction-thumb">
                                            <img src="/assets2/images/transaction/transaction06.png" alt="transaction">
                                        </div>
                                        <div class="transaction-footer">
                                            <span class="amount">Amount</span>
                                            <h5 class="sub-title">0.00449721 XRP</h5>
                                ...
                                <div class="col-lg-4 col-xl-3 col-sm-6">
                                    <div class="transaction-item">
                                        ...
                                        <div class="transaction-thumb">
                                            <img src="/assets2/images/transaction/transaction07.png" alt="transaction">
                                        </div>
                                        <div class="transaction-footer">
                                            <span class="amount">Amount</span>
                                            <h5 class="sub-title">0.00449721 USD</h5>
                                ...
                                <div class="col-lg-4 col-xl-3 col-sm-6">
                                    <div class="transaction-item">
                                        ...
                                        <div class="transaction-thumb">
                                            <img src="/assets2/images/transaction/transaction08.png" alt="transaction">
                                        </div>
                                        <div class="transaction-footer">
                                            <span class="amount">Amount</span>
                                            <h5 class="sub-title">0.00449721 LTC</h5>
                ...
                <div class="row">
                    <div class="col-lg-7 padding-bottom padding-top">
                        ...
                        <div class="affiliate-bottom">
                            <h6 class="title">Make money with Decadetrades</h6>
                    ...
                    <div class="col-lg-5 d-lg-block d-none">
                        <div class="afiliate-thumb">
                            <img src="/assets2/images/affiliate/affiliate.png" alt="affiliate">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-md-7 col-xl-6">
                        <div class="call-item text-center text-sm-left">
                            <div class="call-icon">
                                <img src="/assets2/images/call/icon01.png" alt="call">
                            </div>
                    ...
                    <div class="col-md-5 col-xl-6 text-center text-sm-left text-md-right">
                        <a href="/login" class="custom-button">Invest NOw <i class="flaticon-right"></i></a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="client-section padding-bottom padding-top">
            <div class="background-map">
                <img src="/assets2/images/client/client-bg.png" alt="client">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-10">
                            ...
                            <div class="client-slider owl-carousel owl-theme">
                                <div class="client-item">
                                    ...
                                    <div class="client-thumb">
                                        <a href="#0">
                                            <img src="/assets2/images/client/client01.png" alt="client">
                                        </a>
                                    </div>
                                </div>
                                <div class="client-item">
                                    ...
                                    <div class="client-thumb">
                                        <a href="#0">
                                            <img src="/assets2/images/client/client02.png" alt="client">
                                        </a>
                                    </div>
                                </div>
                                <div class="client-item">
                                    <div class="client-content">
                                        <p>
                                            Awesome Decadetrades' most profitable site!
                                        </p>
                                        <div class="rating">
                                            <span>
                                                <i class="fas fa-star"></i>
                                    ...
                                    <div class="client-thumb">
                                        <a href="#0">
                                            <img src="/assets2/images/client/client03.png" alt="client">
                                        </a>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('inc.frontend_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/amarachi/Documents/laravel/decadetrades/resources/views//frontend/index.blade.php ENDPATH**/ ?>