	...
	<script type="text/javascript">
        $(document).ready(function(){
			...
			$('#pay_with_bank_dep1').on('click', function(){
        		$('#bank_dets1').toggle(1000);
        	});

			$('#pay_with_bank_dep2').on('click', function(){
        		$('#bank_dets2').toggle(1000);
        	});
			...
			$('#bank_deposit_cont1').on('click', function(){
        		$('#bank_deposit_cont_dets').show(1000);
        	});

			$('#bank_deposit_cont2').on('click', function(){
        		$('#bank_deposit_cont_dets').show(1000);
        	});
...
<?php /**PATH /Users/amarachiugwu/Work/laravel/olympuspb-back/resources/views/layouts/atlantis/footer.blade.php ENDPATH**/ ?>