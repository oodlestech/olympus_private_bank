...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row" style="padding-left:25px; text-align: left;">                                                    
                            ...
                            <label style="text-align: left;" class="sign-in-recovery">Forgot your password? 
                                ...
                                <a style="font-size:12px; color:#6A35FF;" class="btn btn-link" href="<?php echo e(route('password.request')); ?>">
...
<?php echo $__env->make('inc.auth_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lotus\resources\views/auth/login.blade.php ENDPATH**/ ?>