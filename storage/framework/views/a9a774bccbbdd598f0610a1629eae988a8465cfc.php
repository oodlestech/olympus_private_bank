	<div class="wrapper">
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									...
									<li>
										...
										<a class="dropdown-item" href="/<?php echo e($user->username); ?>/send_money"><span class="fa fa-paper-plane"></span>&nbsp; Transfer within OlympusPB</a>
										<a class="dropdown-item" href="/<?php echo e($user->username); ?>/send_money_out"><span class="fa fa-paper-plane"></span>&nbsp; Transfer to other Banks</a>
										...
										<a class="dropdown-item" href="/<?php echo e($user->username); ?>/downlines"><span class="fa fa-users"></span>&nbsp; Affiliates</a>
								...
								<ul class="nav nav-collapse">
									<li >
										<a href="/<?php echo e($user->username); ?>/send_money">
											<span class="sub-item">Transfer within Olympus</span>
										</a>
									</li>
									
									<li class="">
										<a href="/<?php echo e($user->username); ?>/send_money_out">
											<span class="sub-item">Transfer to other banks</span>
										</a>
									</li>
		...
		<!-- End Sidebar --><?php /**PATH /Users/amarachiugwu/Work/laravel/olympuspb-back/resources/views/layouts/atlantis/header.blade.php ENDPATH**/ ?>