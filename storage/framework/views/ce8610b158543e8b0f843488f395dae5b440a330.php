                    ...
                    <div class="row">
                       <div class="col-sm-12 card">
                          ...
                          <ul class="nav nav-tabs mt-5" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                              <a class="nav-link" id="bank-tab" data-toggle="pill" href="#bank" role="tab" aria-controls="bank" aria-selected="false">Beneficiaries</a>
                            </li>
                            <li class="nav-item">
                          ...
                          <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="p-5 tab-pane fade " id="bank" role="tabpanel" >
                              <div class="row form-group">
                                <div class="col-sm-12">
                                  <div class="card">
                                    <div class="card-header">
                                        <div class="card-title"><?php echo e(__('Add a beneficiary')); ?></div>
                                    </div>
                                    <div class="card-body">
                                ...
                                <div class="col-sm-12">
                                  <div class="card">
                                    <div class="card-header">
                                        <div class="card-title"><?php echo e(__('My Beneficiaries')); ?></div>
                                    </div>
                            ...
                            <div class="p-5 tab-pane fade " id="kyc" role="tabpanel" >
                              ...
                              <?php elseif(count($kyc) == 0): ?>
                                <form id="id_verify" class="" method="post" action="/kycs" enctype="multipart/form-data">
                                  <div class="row form-group">
                                    <div class="col-sm-6">
                                      <div class="card">
                                        <div class="card-header">
                                            ...
                                            <div class="col-lg-12">
                                                <div id="selfie" class="">
                                                  <div class="form-group" align="center">                                              
                                                    ...
                                                    <!--</p>-->
                                                    <img src="/img/any.png" class="avatar_img" align="center">
...
<?php echo $__env->make('layouts.atlantis.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/amarachiugwu/Work/laravel/olympuspb-back/resources/views/user/profile.blade.php ENDPATH**/ ?>