<div class="wrapper">
		<header class="header-main sm-header">
			<div class="hamburger">
			...
			<div class="container">
					...
					<div class="logo-wrap">
						<a href="/index" class="logo">
							<img src="assets/img/logo.png" class="img-fluid logo__img" alt="">
						</a>
					</div>
					<!-- /.logo-top-wrap -->
		...
		<!-- /.header-main -->
		<!-- /.header-main --><?php /**PATH /home/amarachi/Documents/laravel/triveinvestments/resources/views/inc/frontend_nav.blade.php ENDPATH**/ ?>