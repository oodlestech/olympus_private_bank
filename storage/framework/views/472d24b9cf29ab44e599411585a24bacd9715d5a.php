        ...
        <div class="container">
            ...
            <div class="account-wrapper">
                <div class="account-body">
                    <h4 class="subtitle" style="text-align: left; padding-left:10px; margin-bottom: 20px;color:#212529;">Let's get started</h4>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="account-header" style="text-align: left;">
                    <label class="d-block span-2"><?php echo e(__("Already have an account?")); ?> <a style="font-size:12px; font-weight:600; color:#6A35FF;" href="/login"><?php echo e(__('Login')); ?></a>                             
                    </label>                                                   
...
<?php echo $__env->make('inc.auth_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\OWNER\Documents\laravel\intervest\resources\views/auth/register.blade.php ENDPATH**/ ?>