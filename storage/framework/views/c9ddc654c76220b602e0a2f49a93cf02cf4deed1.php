<div id="div_withdrawal" class="container popmsgContainer" >
    <div class="row wd_row_pad" >
      ...
      <div class="col-md-4 card popmsg-mobile pop_invest_col" align="Center">        
        ...
        <div class="card-body pt-0" >                
          ...
          <form id="wd_formssss" action="/stakings/withdrawal" method="post">
              ...
              <div align="left">
                <label><?php echo e(__('Unstakable Amount')); ?> </label>
              </div>
  ...
  </div><?php /**PATH /Users/amarachiugwu/Work/laravel/olympuspb-back/resources/views/user/inc/unstaking.blade.php ENDPATH**/ ?>