	...
	<div class="page-inner py-5" style="background-color: <?php echo e($settings->header_color); ?>">
		<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
			...
			<div class="ml-md-auto py-2 py-md-0">
                ...
                <?php if($role->role == 3): ?>
					<a href="/admin/manage/withdrawals" class="<?php echo e(request()->is("admin/manage/withdrawals") ? 'btn btn-white btn-border btn-round mr-2' : 'btn btn-secondary btn-round'); ?>">withdrawals</a>
...
</div><?php /**PATH /Users/amarachiugwu/Work/laravel/olympuspb-back/resources/views/admin/atlantis/main_bar.blade.php ENDPATH**/ ?>