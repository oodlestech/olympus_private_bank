                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row py-3 <?php if($adm->role < 2): ?> <?php echo e(blur_cnt); ?><?php endif; ?> position_relative">
                                                        <div class="col-md-6 d-flex flex-column justify-content-around">
                                                            ...
                                                            <a id="wd_bal" title="Click to Edit" href="javascript:void(0)" >
                                                                <div class="border_btm">							
                                                                    ...
                                                                    <div class="colhd margin_n10"><?php echo e(__('Click to Edit Fund')); ?></div>
                                                                </div>
                                                            </a>
                                                            ...
                                                            <a id="wd_ref_bal" title="Click to Edit" href="javascript:void(0)" >
                                                                <div class="border_btm">							
                                        ...
                                        <div id="wallet_wd" class="container popmsgContainer" >
                                            <div class="row padding_per_2_2">
                                              ...
                                              <div class="col-md-4 popmsg-mobile card" align="Center">        
                                                <div class="card-title">
                                                  <br>
                                                  <h3><b><?php echo e(__('Edit Wallet Balance')); ?></b></h3>
                                                  <h5 class="text-danger"><b><?php echo e(__('Wallet Balance:')); ?></b></h5> 
                                                              <h3 class="fw-bold">$ <?php echo e(number_format($user->wallet, 2)); ?></h3>
                                        
                                                  <hr>
                                                </div>
                                                <div class="card-body">
                                                    <form id="wd_formssss" action="/walletTopUp" method="post">
                                                        ...
                                                        <div class="form-group">
                                                          <div class="input-group">
                                                            ...
                                                            <input id="wd_amt" type="text" class="form-control" name="amt" required placeholder="Enter Wallet Amount to update" >
                                                          </div>
                                                        </div>
                                                        <input id="" type="hidden" class="form-control" name="bank" value="<?php echo e($user->id); ?>"  required placeholder="Enter Amount to update" >
                                                        <div class="form-group">
                                                          <br><br>
                                            ...
                                            <div class="row padding_per_2_2">
                                              ...
                                              <div class="col-md-4 popmsg-mobile card" align="Center">        
                                                <div class="panel-heading" style="">
                                                  <br>
                                                  <h3><b><?php echo e(__('Edit Referral Bonus')); ?></b></h3>
                                                  <h5 class="text-danger"><b><?php echo e(__('Referral Bonus:')); ?></b>$<?php echo e($user->ref_bal); ?></h5>         
                                                  <hr>
                                                </div>
                                                <div id="" >
                                                      <?php echo e(__('Enter Referral Bonus')); ?>

                                                     <form id="wd_formssss" action="/refBonusTopUp" method="post">
                                                        <div class="form-group" align="left">                       
                                                            <input type="hidden" class="form-control" name="_token" value="<?php echo e(csrf_token()); ?>">
                                                        </div>
                                                        <div class="form-group">
                                                          <div class="input-group">
                                                            ...
                                                            <input id="ref_amt" type="text" class="form-control" name="amt"  required placeholder="Enter Bonus Amount to update" >
                                                          </div>
                                                        </div>
                                                        <input id="" type="hidden" class="form-control" name="bank" value="<?php echo e($user->id); ?>"  required placeholder="Enter Bonus Amount to update" >
                                                        <div class="form-group">
                                                          <br><br>
                                                            <button class="collb btn btn-info"><?php echo e(__('Update')); ?></button>
                                                            <span style="">            
...
<?php echo $__env->make('admin.atlantis.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/amarachi/Documents/laravel/triveinvestments/resources/views/admin/user_details.blade.php ENDPATH**/ ?>