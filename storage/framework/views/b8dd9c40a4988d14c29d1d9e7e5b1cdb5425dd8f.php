...
<div class="row mt--2">
	<div class="col-md-6">
		<div class="card">
			<div class="card-body">
				<div class="card-title"><h2><?php echo e(__('Balances')); ?></h2></div><hr>
				<div class="row py-3">
                ...
                color: #eee;">
								...
								<h4 class="fw-bold text-uppercase btn-secondarys op-8"><?php echo e(__('Wallet')); ?></h4>
            ...
            <a id="wd_ref_bal" title="Click to withdraw" href="javascript:void(0)">
              ...
              color: #eee;">
								...
								<h4 class="fw-bold text-uppercase btn-secondarys op-8"><?php echo e(__('Referral Bonus')); ?></h4>
	...
	<div class="col-md-6">
      ...
      <div class="card-body">
        <div class="card-title"><h2><?php echo e(__('Account Details')); ?></h2></div><hr>

          
              
              <div class="admin-comment-month" align="left" style="font-size: 16px;">
                  
                  <div align="left">Account Name:<b> <?php echo e(ucfirst($user->firstname).' '.ucfirst($user->lastname)); ?> </b></div><hr>

                  <div align="left">Account Number:<b> <?php echo e($user->account_number); ?> </b></div> <hr>
...
<div id="ref_wd" class="container popmsgContainer" >
  ...
  </div><?php /**PATH /Users/amarachiugwu/Work/laravel/olympuspb-back/resources/views/user/atlantis/overview.blade.php ENDPATH**/ ?>