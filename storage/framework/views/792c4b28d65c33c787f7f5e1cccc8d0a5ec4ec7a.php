...
<?php $__env->startSection('content'); ?>
    ...
    <section class="bg_img hero-section-2 " data-background="/assets2/images/about/hero-bg4.png">
            <div class="container">
        ...
        <section class="affiliate-programe padding-top pt-max-lg-0">
            ...
            data-paroller-type="foreground" data-paroller-direction="horizontal">
                <img src="/assets2/images/balls/ball4.png" alt="balls">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-7 padding-bottom padding-top">
                        ...
                        <div class="affiliate-bottom">
                            ...
                            <a href="/login" class="custom-button">
                                Start Now <i class="flaticon-right"></i>
                            </a>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-5 col-xl-6 text-center text-sm-left text-md-right">
                        <a href="/login" class="custom-button">learn more <i class="flaticon-right"></i></a>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-4 d-lg-block d-none">
                        <div class="total-thumb rtl">
                            <img src="/assets2/images/affiliate/total-1.png" alt="affiliate">
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="total-content">
                            <div class="total-bg">
                                <img src="/assets2/images/affiliate/affiliate-bg2.png" alt="affiliate">
                            </div>
                            <div class="tot-wrapper">
                                <div class="tot-area">
                                    <div class="tot-item">
                                        <div class="tot-thumb">
                                            <img src="/assets2/images/affiliate/tot1.png" alt="affiliate">
                                        </div>
                                        <div class="tot-content">
                                            <div class="counter--item">
                                                <div class="counter-header">
                                                    <h2 class="title odometer" data-odometer-final="174">0</h2>
                                                </div>
                                                <p>
                                                    Supported Countries
                                                </p>
                                    ...
                                    <div class="tot-item">
                                        <div class="tot-thumb">
                                            <img src="/assets2/images/affiliate/tot3.png" alt="affiliate">
                                        </div>
                                        <div class="tot-content">
                                            <div class="counter--item">
                                                <div class="counter-header">
        ...
        <section class="how-section bg_img padding-top padding-bottom pt-max-md-0" data-background="/assets2/images/affiliate/affiliate-bg.png">
            <div class="ball-3" data-paroller-factor="-0.30" data-paroller-factor-lg="0.60"
            data-paroller-type="foreground" data-paroller-direction="horizontal">
                <img src="/assets2/images/balls/ball-group9.png" alt="balls">
            </div>
            <div class="ball-2" data-paroller-factor="0.30" data-paroller-factor-lg="-0.30"
            data-paroller-type="foreground" data-paroller-direction="horizontal">
                <img src="/assets2/images/balls/ball-group10.png" alt="balls">
            </div>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="section-header">
                            ...
                            <p>
                                The affiliate program is our special feature for loyal Investors.Invite users and earn up to 12% of the fee on their exchange transactions!
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6 col-lg-4 col-sm-10">
                        <div class="how-item">
                            <div class="how-thumb-area">
                                <div class="how-thumb">
                                    <img src="/assets2/images/how/how4.png" alt="how">
                                </div>
                            </div>
                            <div class="how-content">
                                <h5 class="title">Join Program</h5>
                                <a href="/login">Join Now <i class="flaticon-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 col-sm-10">
                        <div class="how-item active">
                            <div class="how-thumb-area">
                                <div class="how-thumb">
                                    <img src="/assets2/images/how/how5.png" alt="how">
                                </div>
                            </div>
                            <div class="how-content">
                                <h5 class="title">Promote</h5>
                                <a href="/login">Tracking Link <i class="flaticon-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 col-sm-10">
                        <div class="how-item">
                            <div class="how-thumb-area">
                                <div class="how-thumb">
                                    <img src="/assets2/images/how/how6.png" alt="how">
                                </div>
                            </div>
                            <div class="how-content">
                                <h5 class="title">Earn</h5>
                                <a href="/login">Commission Model <i class="flaticon-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="why-affiliate-section padding-bottom padding-top pt-max-lg-0">
            <div class="why--thumb">
                <img src="/assets2/images/why/how.png" alt="why">
            </div>
            <div class="container">
                        ...
                        <div class="why-affiliate-content">
                            ...
                            <div class="why-area">
                                <div class="why-item">
                                    <div class="why-inner">
                                        <div class="why-thumb">
                                            <img src="/assets2/images/why/why1.png" alt="why">
                                        </div>
                                ...
                                <div class="why-item">
                                    <div class="why-inner">
                                        <div class="why-thumb">
                                            <img src="/assets2/images/why/why2.png" alt="why">
                                        </div>
                                        <div class="why-content">
                                ...
                                <div class="why-item">
                                    <div class="why-inner">
                                        <div class="why-thumb">
                                            <img src="/assets2/images/why/why3.png" alt="why">
                                        </div>
                                        <div class="why-content">
                                ...
                                <div class="why-item">
                                    <div class="why-inner">
                                        <div class="why-thumb">
                                            <img src="/assets2/images/why/why4.png" alt="why">
                                        </div>
                                        <div class="why-content">
                            ...
                            <a href="/login" class="custom-button">join Now!</a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('inc.frontend_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/amarachi/Documents/laravel/decadetrades/resources/views//frontend/affiliate.blade.php ENDPATH**/ ?>