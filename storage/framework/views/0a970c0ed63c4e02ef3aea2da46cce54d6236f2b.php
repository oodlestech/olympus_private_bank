			...
			<div class="card-body">
				...
				<div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
					...
					<div class="px-2 pb-2 pb-md-0 text-center">
						...
						<h6 class="fw-bold mt-3 mb-0"><?php echo e(__('Affiliates')); ?></h6>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="card full-height">
            ...
            <a href="#">
              ...
              color: #eee;">
  							...
  							<h4 class="fw-bold text-uppercase btn-secondarys op-8"><?php echo e(__('Earning')); ?></h4>
...
<div id="ref_wd" class="container popmsgContainer" >
  ...
  </div><?php /**PATH /home/amarachi/Documents/laravel/triveinvestments/resources/views/user/atlantis/overview.blade.php ENDPATH**/ ?>