<section class="py-24 bg-#eee">
  <div class="container">
    ...
    <div class="row align-items-center">
      <?php                
          $invs = App\Stake::where('status', 1)->orderby('id', 'asc')->get();                
      ?>
      <?php if($user->phone != ''): ?>
            ...
            <div class="p-12 mw-md mx-auto bg-dark" style="margin-bottom:20px; padding: 20px; background-color: #598FFA !important;">
              ...
              <ul class="list-unstyled mb-10" style="color:#eee">
                <li class="text-#eee lh-lg d-flex mb-2">
                  ...
                  <span><?php echo e(__('Period of Staking')); ?> <?php echo e($inv->period); ?> <?php echo e(__('Days')); ?></span>
                </li>
                <li class="text-#eee lh-lg d-flex mb-2">
                  <i class="fa fa-cube tx-primary mg-r-8" style="display: inline-block; margin-right:10px"></i>
                  <span><?php echo e(__('Min Staking')); ?> <?php echo e($settings->currency); ?> <?php echo e($inv->min); ?></span>
                </li>
                <li class="text-#eee lh-lg d-flex mb-2">
                  <i class="fa fa-cube tx-primary mg-r-8" style="display: inline-block; margin-right:10px"></i>
                  <span><?php echo e(__('Max Staking')); ?> <?php echo e($settings->currency); ?> <?php echo e($inv->max); ?></span>
                </li>
                <li class="text-#eee lh-lg d-flex mb-2">
                  <i class="fa fa-cube tx-primary mg-r-8" style="display: inline-block; margin-right:10px"></i>
                  <span><?php echo e(__('APR')); ?> <?php echo e($inv->daily_interest*$inv->period*100); ?>%</span>
                </li>
                <li class="text-#eee lh-lg d-flex">
                  <i class="fa fa-cube tx-primary mg-r-8" style="display: inline-block; margin-right:10px"></i>
                  <span><?php echo e(__('Unstaking Interval')); ?> <?php echo e($inv->days_interval); ?> Days</span>
                </li>
              </ul>
              <div class="" style="color: #fff" align="center">
                  <p><?php echo e(__('Funds accessible after staking elapses.')); ?></p>
              </div>
      ...
      <?php else: ?>
        <div class="alert alert-warning">
            <a href="/<?php echo e($user->username); ?>/profile#userdet"><?php echo e(__('Please, click here to update your profile before you can stake.')); ?></a>
        </div>
      <?php endif; ?>
...
<?php /**PATH /Users/amarachiugwu/Work/laravel/olympuspb-back/resources/views/user/inc/stake.blade.php ENDPATH**/ ?>