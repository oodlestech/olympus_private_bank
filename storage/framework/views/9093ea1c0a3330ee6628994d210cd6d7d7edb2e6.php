                                ...
                                <div class="card-header card_header_bg_blue">
                                    <div class="card-head-row card-tools-still-right">
                                        ...
                                        <div class="card-tools">
                                            <a href="/admin/create/package" style="background-color: #7a66e1 !important" class="btn btn-default"><i class="fa fa-plus"></i> <?php echo e(__('Add')); ?> </a>
                                        </div>                                                                       
                                    </div>
                                </div>
...
<?php echo $__env->make('admin.atlantis.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/amarachi/Documents/laravel/triveinvestments/resources/views/admin/inv_packages.blade.php ENDPATH**/ ?>