    ...
    <div class="row">
        ...
        <div class="col-sm-4" style="border:1px solid #CCC; padding:4%; box-shadow:2px 2px 4px 4px #CCC;">
            <table class="table_boder">
                <tr>
                    <td></td>
                    <td><img src="<?php echo e(env('APP_URL')); ?>/img/<?php echo e($st->site_logo); ?>" style="height:100px; width:96px;" align="center"></td>
                    <td></td>
                </tr>
                <tr>
                    <td></td>
...
</html><?php /**PATH /home/oodlbkoj/triveinvestments.com/resources/views/mail/admin_kyc_not.blade.php ENDPATH**/ ?>