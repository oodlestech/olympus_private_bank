...
<body>
	<div class="wrapper">
								...
								<div class="dropdown-adm-scroll scrollbar-outer">
									...
									<li>																			
                                        ...
                                        <?php if($role->role == 3): ?>
											...
											<a class="dropdown-item" href="/admin/manage/transfers">
												<span class="fa fa-file"></span>&nbsp; User Transfers 
											</a>
										<?php endif; ?>
		...
		<!-- End Sidebar --><?php /**PATH /Users/amarachiugwu/Work/laravel/olympuspb-back/resources/views/admin/atlantis/header.blade.php ENDPATH**/ ?>