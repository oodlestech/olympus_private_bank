                          ...
                          <div class="p-5 tab-pane fade" id="payment_setting_tab" role="tabpanel" aria-labelledby="payment_setting_tab-tab">
                            <div class="row "> 
                              ...
                              <div class="col-md-6">
                                <div class="card pad_20" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="bank_name1" value="<?php echo e(env('BANK_NAME1')); ?>" class="form-control"  >
                                    </div>
                                    <div class="form-group">
                                        <h5> <?php echo e(__('Account Name')); ?> </h5>
                                        <input type="text" name="act_name1" value="<?php echo e(env('ACCOUNT_NAME1')); ?>" class="form-control" placeholder="" >
                                    </div> 

                                    <div class="form-group">
                                        <h5> <?php echo e(__('Account Number')); ?> </h5>
                                        <input type="text" name="act_no1" value="<?php echo e(env('ACCOUNT_NUMBER1')); ?>" class="form-control" placeholder="" >
                                    </div> 
                                    <div class="form-group">
                                        <h5> <?php echo e(__('Response Email')); ?> </h5>
                                        <input type="email" name="dep_email1" value="<?php echo e(env('BANK_DEPOSIT_EMAIL1')); ?>" class="form-control" placeholder="" >
                                    </div>  
                                    <div class="" align="right"> 
                                        <b>On/Off</b><br>             
                                        <label class="switch">
                                          <input id="switch_bank_deposit1" type="checkbox" name="switch_bank_deposit1"  value="<?php echo e(env('BANK_DEPOSIT_SWITCH1')); ?>" <?php if(env('BANK_DEPOSIT_SWITCH1') == 1): ?><?php echo e('checked'); ?><?php endif; ?>>
                                          <span id="" class="slider round" onclick="checkedOnOff('switch_bank_deposit1')"></span>
                                        </label>
                                    </div>                                                     
                                </div>                                                   
                              </div>
                              ...
                              <div class="col-md-6">
                                  <div class="card pad_20" >
                                      <h3 align="center"><i class="far fa-building fa-3x"></i></h3>
                                      <h2 class="text-center">Direct Wallet Deposit Setup</h2>
                                      <hr>


                                      <div class="form-group">
                                          <h5> <?php echo e(__('Wallet Address Host 1/Address Type 1')); ?> </h5>
                                          <input type="text" name="bank_name" value="<?php echo e(env('BANK_NAME')); ?>" class="form-control" placeholder="Eg : Coinbase, Binance, Metamask etc"  >
                                      </div>
                                      <div class="form-group">
                                          <h5> <?php echo e(__('Wallet Address 1')); ?> </h5>
                                      ...
                                      <div class="form-group">
                                          <h5> <?php echo e(__('Wallet Address Host 2/Address Type 2')); ?> </h5>
                                          <input type="text" name="bank_name2" value="<?php echo e(env('BANK_NAME2')); ?>" class="form-control" placeholder="Eg : Coinbase, Binance, Metamask etc"  >
                                      </div>
                                      <div class="form-group">
                                          <h5> <?php echo e(__('Wallet Address 2')); ?> </h5>
                                          <input type="text" name="act_name2" value="<?php echo e(env('ACCOUNT_NAME2')); ?>" class="form-control" placeholder="" >
                                      </div> 



                                      <div class="form-group">
                                          <h5> <?php echo e(__('Wallet Address Host 3/Address Type 3')); ?> </h5>
                                          <input type="text" name="bank_name3" value="<?php echo e(env('BANK_NAME3')); ?>" class="form-control" placeholder="Eg : Coinbase, Binance, Metamask etc"  >
                                      </div>
                                      <div class="form-group">
                                          <h5> <?php echo e(__('Wallet Address 3')); ?> </h5>
                                          <input type="text" name="act_name3" value="<?php echo e(env('ACCOUNT_NAME3')); ?>" class="form-control" placeholder="" >
                                      </div>  


                                      <div class="form-group">
                                        <h5> <?php echo e(__('Wallet Address Host 4/Address Type 4')); ?> </h5>
                                        <input type="text" name="bank_name3" value="<?php echo e(env('BANK_NAME3')); ?>" class="form-control" placeholder="Eg : Coinbase, Binance, Metamask etc"  >
                                      </div>
                                      <div class="form-group">
                                          <h5> <?php echo e(__('Wallet Address 4')); ?> </h5>
                                          <input type="text" name="act_name4" value="<?php echo e(env('ACCOUNT_NAME4')); ?>" class="form-control" placeholder="" >
                                      </div> 


                                      
                                          
                                          <input type="hidden" value="NIL" name="act_no" value="<?php echo e(env('ACCOUNT_NUMBER')); ?>" class="form-control" placeholder="" >
...
<?php echo $__env->make('admin.atlantis.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/amarachiugwu/Work/laravel/olympuspb-back/resources/views/admin/settings.blade.php ENDPATH**/ ?>