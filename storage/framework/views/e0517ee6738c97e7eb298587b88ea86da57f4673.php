                                            ...
                                            <?php if(count($kyc) > 0 ): ?>
                                                <?php $__currentLoopData = $kyc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a target="_blank" href="<?php echo e(env('APP_URL').'/img/kyc/'.$user->selfie); ?>" class=" text-info">
                                                                <i class="fa fa-eye"></i>View
                                                            </a>
                                                        </td> 
                                                        <td><?php echo e($user->card_type); ?></td>
                                                        <td>
                                                            <a target="_blank" href="<?php echo e(env('APP_URL').'/img/kyc/'.$user->front_card); ?>" class=" text-info">
                                                                <i class="fa fa-eye"></i>View
                                                            </a>
                                                        </td>  
                                                        <td>
                                                            <?php if(!empty($user->back_card)): ?>
                                                            <a target="_blank" href="<?php echo e(env('APP_URL').'/img/kyc/'.$user->back_card); ?>" class=" text-info">
                                                                <i class="fa fa-eye"></i>View
                                                            </a>
                                                            <?php endif; ?>
                                                        <td>
                                                            <a target="_blank" href="<?php echo e(env('APP_URL').'/img/kyc/'.$user->address_proof); ?>" class=" text-info">
                                                                <i class="fa fa-eye"></i>View
                                                            </a>                                                            
                                                        </td>
                                                        <td>
...
<?php echo $__env->make('admin.atlantis.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/amarachiugwu/Work/laravel/olympuspb-back/resources/views/admin/kyc.blade.php ENDPATH**/ ?>