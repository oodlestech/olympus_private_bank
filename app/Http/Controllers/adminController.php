...
class adminController extends Controller
{
  ...
  public function searchTF(Request $req)
  {        
    if(Session::has('adm') && !empty(Session::get('adm')))
    {  
      Session::put('val', $req->input('search_val'));
  ...
  public function editDep(Request $req, $id)
  {        
    if(Session::has('adm') && !empty(Session::get('adm')))
    {       
      ...
      {
        $usr = deposits::find($id);         
        $usr->created_at = $req->input('txn_date');;  
        ...
        $act = new adminLog;
        $act->admin = $adm->email;
        $act->action = "Changed deposit date. Deposit id: ".$id;
        $act->save();

        return back()->with([
          'toast_msg' => 'Date changed successfully!',
          'toast_type' => 'suc'
        ]);
      ...
      {
        return back()->with([
          'toast_msg' => "Error changing date! Try again",
          'toast_type' => 'err'
        ]);
        return back();
      }    
  ...
  public function editWD(Request $req, $id)
  {        
    if(Session::has('adm') && !empty(Session::get('adm')))
    {       
      ...
      {
        $usr = withdrawal::find($id);         
        $usr->created_at = $req->input('wid_txn_date');;  
        ...
        $act = new adminLog;
        $act->admin = $adm->email;
        $act->action = "Changed Withdrawal date. Withdrawal id: ".$id;
        $act->save();
      ...
      {
        return back()->with([
          'toast_msg' => "Error changing date! Try again " .$id .$e->getMessage(),
          'toast_type' => 'err'
        ]);
        return back();
      }    
  ...
  {        
    ...
    {       
      ...
      try
      {
        $usr = transfer::find($id);   
        
        if($usr->status == 'Rejected')
        {
          return back()->with([
            'toast_msg' => 'transfer already rejected!',
            'toast_type' => 'err'
          ]);
        }
        ...
        $act = new adminLog;
        $act->admin = $adm->email;
        $act->action = "Rejected user transfer. transfer id: ".$id;
        $act->save();
    
        return back()->with([
            'toast_msg' => 'Transfer Rejected Successfully and Funds Added Back to User Wallet!',
            'toast_type' => 'suc'
        ]);
      ...
      {
        return back()->with([
          'toast_msg' => 'Error updating record! Try again! '.$e,
          'toast_type' => 'err'
        ]);
      }
  ...
  {        
    ...
    {       
      ...
      try
      {
        ...
        {
          return back()->with([
            'toast_msg' => 'Transfer already approved!',
            'toast_type' => 'err'
          ]);
        }
        ...
        {
          return back()->with([
            'toast_msg' => 'Transfer already rejected. User has to create an new transfer request.',
            'toast_type' => 'err'
          ]);
        }
        ...
        $wd_act = $usr->acct_no; 
        $wd_amt = $usr->amount;
        $wd_currency = $this->settings->currency;
        $usr->status = 'Approved';
        $usr->save();
        ...
        $act = new adminLog;
        $act->admin = $adm->email;
        $act->action = "Approved user transfer. transfer id: ".$id;
        $act->save();
  ...
  {        
    ...
    {       
      ...
      try
      {
        ...
        $act = new adminLog;
        $act->admin = $adm->email;
        $act->action = "Deleted user transfer. transfer id: ".$id;
        $act->save();
      ...
      {
        return back()->with([
          'toast_msg' => 'Error Deleting record! Try again '.$e,
          'toast_type' => 'err'
        ]);
      }
  ...
  {        
    if(Session::has('adm') && !empty(Session::get('adm')))
    {
      try
      {
        $pack = stakes::find($req->input('p_id'));
    ...
    { 
      ...
      try
      {
        ...
        $file = DotenvEditor::setKeys([
          ...
          [
            'key'     => 'BANK_NAME2',
            'value'   => $req->input('bank_name2')
          ],
          [
            'key'     => 'BANK_NAME3',
            'value'   => $req->input('bank_name3')
          ],
          [
            'key'     => 'BANK_NAME4',
            'value'   => $req->input('bank_name4')
          ],
          [
              'key'     => 'ACCOUNT_NUMBER',
          ...
          [
              'key'     => 'ACCOUNT_NAME2',
              'value'   => $req->input('act_name2')
          ],
          [
              'key'     => 'ACCOUNT_NAME3',
              'value'   => $req->input('act_name3')
          ],
          [
              'key'     => 'ACCOUNT_NAME4',
              'value'   => $req->input('act_name4')
          ],
          [
          ...
          [
            'key'     => 'BANK_NAME1',
            'value'   => $req->input('bank_name1')
          ],
          [
              'key'     => 'ACCOUNT_NUMBER1',
              'value'   => $req->input('act_no1')
          ],
          [
              'key'     => 'ACCOUNT_NAME1',
              'value'   => $req->input('act_name1')
          ],
          [
              'key'     => 'BANK_DEPOSIT_EMAIL1',
              'value'   => $req->input('dep_email1')
          ],
          [
              'key'     => 'BANK_DEPOSIT_SWITCH1',
              'value'   => is_null($req->input('switch_bank_deposit1')) ? 0 : $req->input('switch_bank_deposit1')
          ],
  ...
  public function create_stake_post(Request $req)
  {
    if(Session::has('adm') && !empty(Session::get('adm')))
    { 
        $val = Validator::make($req->all(),[
  ...
  public function adminDeleteStake($id){
    if(Session::has('adm') && !empty(Session::get('adm')))
    { 
      try{
