...
{ 
	...
	$('#date_modal').click( function(){
        ...
        $("#txn_form").attr("action", '/admin/edit/user/payment/'+value);
		$('#change_date').show();
	});

    $('#wid_date_modal').click( function(){
        var value = $(this).attr("data-value");
        $("#wid_txn_form").attr("action", '/admin/edit/user/wd/'+value);
		$('#wid_change_date').show();
	});
...
function fetch_recievers_name(url)
{
        ...
        ({
            ...
            { 
                ...
                {          
                    ...
                    $('#form_name').show();
                    $('#verify_group').hide();
                    $('#recievers_name').val(result.firstname + ' ' + result.lastname)
                    $('#recievers_username').val(result.username)
            ...
            error: function (error) {	
                console.log('error');
                $('#err').html(error.msg);
                $('#err').show().animate({ width: "30%" }, "1000").delay(10000).animate({ width: "-50px" }, "1000").fadeOut(50);
                $('#p_loading').hide();	
            }
        }); 
